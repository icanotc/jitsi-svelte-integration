...
<main class="container m-auto flex justify-center items-center">
    ...
    <div class="flex flex-row space-x-2">
        <button class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded" on:click={() => muteStatus = !muteStatus}>
            {#if muteStatus}
        ...
        <button class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded" on:click={() => videoStatus = !videoStatus}>
            {#if videoStatus}
